      ...
      <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.Benefits)}>
        ...
        >
          {
            benefits.map((benefit: BenefitType) => (
              <Benefit key={benefit.title} icon={benefit.icon} title={benefit.title} desc={benefit.desc} setSelectedPage={setSelectedPage} />
            ))
          }
        </motion.div>
        ...
        <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
          ...
          <div>
            ...
            {/* Button */}
            <div className="relative">
              <div className="before:absolute before:-bottom-20 before:right-10 md:before:right-40 before:z-[-1] before:content-sparkles">
